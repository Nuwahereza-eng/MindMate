...
export const en = {
  ...
  recaptchaNotReadyOrFailedShort: "reCAPTCHA not ready. Please try again.",
  enterPhoneNumberToVerify: "Verify {{phoneNumber}}",
  enterPhoneNumberToVerifyE164: "We'll send a verification code to {{phoneNumber}}. Standard rates may apply.",
  ensureCountryCode: "Please ensure your phone number includes the country code (e.g., +12223334444).",
  ensureE164Format: "Use E.164 format (e.g. +12223334444).",
  back: "Back",
  user: "User", 
  tryAgainLater: "Please try again later.",
  invalidPhoneNumberFormat: "Invalid phone number format. Please include your country code (e.g., +1234567890).",
  invalidPhoneNumberFormatE164: "Invalid phone number. Please use E.164 format (e.g. +12223334444).",
  ...
  checkYourConnection: "Please check your internet connection and try again.",
  // Chat
